...
// The variable will change from X to O based on what player turn it is. 
// We need to hold this so we can place an X or O on the board when they're clicked.
let currentMarker = 'X'




// this "handleClick" function is called when a box is clicked. 
//Here, "element" will hold the same value as "this" does in the HTML. 
// "this" is a special word in JS but "element" could have been "thing" 
//or "el" or whatever we wanted it to be as long as we use it again in the "console.log" statement
